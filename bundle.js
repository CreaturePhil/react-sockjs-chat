...
var App = (function (_React$Component) {
  ...
  function App(props) {
    ...
    _this.handleAddMessage = _this.handleAddMessage.bind(_this);
  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      ...
      sockjs.onmessage = function (_ref) {
        var data = _ref.data;
        _this2.setState({ messages: _this2.state.messages.concat([data]) });
      };
    ...
    key: 'handleAddMessage',
    value: function handleAddMessage(message) {
      sockjs.send(message);
    }
  }, {
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(MessageInput, { onAddMessage: this.handleAddMessage }),
...
var MessageInput = (function (_React$Component2) {
  ...
  _createClass(MessageInput, [{
    key: 'handleAddMessage',
    value: function handleAddMessage(e) {
      e.preventDefault();
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        { onSubmit: function onSubmit(e) {
            return _this4.handleAddMessage(e);
          } },
...
var MessageList = (function (_React$Component3) {
  ...
  _createClass(MessageList, [{
    key: 'renderMessage',
    value: function renderMessage(message, index) {
      return _react2.default.createElement(Message, { message: message, key: index });
    }
  }, {
    key: 'render',
    value: function render() {
